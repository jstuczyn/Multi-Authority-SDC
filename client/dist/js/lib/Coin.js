...
class Coin {
    ...
    static getTimeToLive() {
        ...
        const endOfDayTime = new Date(  currentTime.getFullYear(),
        ...
        if (hoursUntilEndOfDay < MIN_TTL_H) { // if it's less than MIN hours until end of day, set TTL to end of day plus 24h
