...
export const merchant = (process.env.NODE_ENV === 'production') ? '35.177.203.169:3001' : '127.0.0.1:4000';

export const issuer = (process.env.NODE_ENV === 'production') ? '35.178.63.67:3002' : '127.0.0.1:5000';
